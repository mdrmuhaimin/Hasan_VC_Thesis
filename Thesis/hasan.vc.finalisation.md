...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [**Umrahme**](https://www.umrahme.com/home/en-us) | Dubai, UAE | B2C OTA | Commission per booking | GCC, SEA, diaspora | Backed by Certares & Global Ventures | Nusuk-accredited, holistic packages | No in-trip or offline features | Add Ritual Mode + licensed marketplace |
| [**Zamzam.com**](https://zamzam.com/) | Jeddah, KSA | B2B/B2C OTA | Package pricing | Global pilgrims | JV with TBO; undisclosed funding | Visa + hotel integration, multilingual support | No exploration/offline features | Curated city plans + licensed services |
| [**TBO Umrah**](https://www.tbo.com/tbo-umrah) | UAE/KSA | B2B OTA | Agency commission-based | Travel agents (GCC/SEA) | Regional player | Agent distribution network | No D2C presence or in-trip UX | D2C Ritual Mode + upsell via agents |
| [**Funadiq**](https://www.funadiq.com/) | Pakistan/KSA | B2C OTA via Maqam GDS | OTA package pricing | Global pilgrims via GDS | Limited public data | Maqam-certified GDS connectivity | No in-trip concierge or exploration features | Integrate Ritual Mode + curated city plans |
| [**Almosafer](https://mid-east.info/almosafer-named-the-official-flight-partner-for-the-direct-hajj-initiative-through-nusuk-hajj-the-official-platform-by-the-ministry-of-hajj-and-umrah/) / [Seera](https://www.seera.sa/wp-content/uploads/2024/05/SEERA-1Q24-Investor-Presentation_vf.pdf)** | Riyadh, KSA | OTA | OTA pricing | KSA/global travelers | Seera publicly held (~$1.6B rev est.) | Brand, supply breadth | Not fiqh-aware, generic UX | Add Ritual Mode + exploration overlay ([Zawya](https://www.zawya.com/en/press-release/companies-news/the-ministry-of-hajj-and-umrah-partners-with-almosafer-to-enhance-pilgrim-travel-experience-in-the-kingdom-i04xv9bs)) |
| [**Flynas (Umrah Services)**](https://nasholidays.com/umrah_packages/en) | Riyadh, KSA | Airline + Umrah packages | Dynamic bundle pricing | Budget pilgrims | Airline revenue significant | Transport integrated with tours | No offline/ritual guidance | Layer Ritual Mode + Ziyarah Explorer |
| [**Saudia Airlines Packages**](https://www.saudia.com/pages/travel-with-saudia/book-with-us/umrah-by-saudia) | Jeddah, KSA | Airline + Umrah bundles | Package pricing (PKR 60k–180k est.) | Pakistani & SEA pilgrims | Government carrier | Trust, flight + stay bundles | No pilgrimage-specific UI | Add Ritual Mode integration |
| [**Amal (Malaysia Airlines)**](https.iflyamal.com/) | Kuala Lumpur | Chartered Umrah arm | Charter/package pricing | SEA markets | Owned by Malaysia Aviation Group | Religious flight brand positioning | No in-destination tools | Bundle Ritual Mode + licensed services |
| [**Muslim Pro (Umrah)**](https://www.muslimpro.com/umrah/) | Global (App) | App-based booking links | Commission from OTA fees | Muslim diaspora | 170M+ downloads, strong base | Nusuk integration, massive user base | No offline support or licensing transparency | Offline Ritual Mode + licensed marketplace |
| [**HalalTrip**](https://www.halaltrip.com/islamic-travel-app/) | Singapore | Content + OTA | Commission/ad revenue | Global Muslim travelers | Backed by CrescentRating | SEO + content-driven reach | No Umrah concierge or licensed services | Integrate ritual content + licensed bookings |
| [**ShareTrip**](https://sharetrip.net/) | Bangladesh | OTA: flight/hotel/packages | OTA pricing | Bangladeshi/Muslim travelers | Leading OTA in BD | Full travel stack: visa, flights, packages | No in-trip ritual features | Embed Ritual Mode + offer licensed service bundles |
| [**GoZayaan**](https://www.gozayaan.com/) | Bangladesh | OTA | Flight deals: BDT 49k–190k | Bangladeshi travelers | Emerging OTA | Flight comparison & deals | No pilgrimage-specific UX or ritual tools | Bundle offline Ritual Mode + local service marketplace |
| [**AmarSafar**](https://amarsafar.com/) | Bangladesh | B2B2C Travel Marketplace | OTA-style pricing | Agencies & travelers | Local focus; app-based | One-stop travel services: visa, flights, tours | Not pilgrimage-specific | Add Ritual & Ziyarah features + licensed services |

---

| Company | What they do | Strengths | Weaknesses vs Us | Gap we exploit |
| --- | --- | --- | --- | --- |
| [**HalalTrip**](https://www.halaltrip.com/islamic-travel-app/) | Muslim travel app (food, mosques, qibla, trip ideas) | Community & utilities | Not Umrah-specific; limited in-trip logistics | **Pilgrimage-specific offline ritual + marketplace**. ([Apple](https://apps.apple.com/us/app/halal-trip-food-travel-prayer/id680194589)) |
| [**Have Halal Will Travel (HHWT)**](https://www.havehalalwilltravel.com/) | Media/community for halal travel | Reach & content | No bookings; no Umrah concierge | **Convert content demand into licensed services**. |
| [**CrescentRating / GMTI**](https://www.crescentrating.com/reports/global-muslim-travel-index-2025.html) | Industry research & destination ratings | Category authority | Not consumer concierge | **Use insights; don’t compete**. |

---

| Category | Players | What users get | Weakness vs us | Our angle |
| --- | --- | --- | --- | --- |
| **Ride-hailing / Taxis** | [**Careem](https://www.careem.com/en-AE/ksa-rides/), [Uber](https://www.uber.com/en-SA/blog/update-to-services/), [Jeeny](https://www.jeeny.me/)** | App rides with upfront fares | Not ritual-aware; not curated for ziyarah; meter compliance still variable | **Pre-quoted, license-badged transfers; meter prompts & receipt checks**. |
| **eSIM / Connectivity** | [**Airalo](https://www.airalo.com/saudi-arabia-esim), [Holafly](https://esim.holafly.com/esim-saudi-arabia/), [Nomad](https://www.getnomad.app/saudi-arabia-eSIM)** | Quick data on arrival | No pilgrimage UX; spotty value vs local SIMs | **Bundle eSIM with app + offline failover**. |
...
| FH9: eSIM bundles as failover (Connectivity). | SIM issues in 19/30; pre-trip JTBD indicate utility. | Onboarding tests; adoption rate in beta. | Validated via Interviews (19/30 support); Needs Beta Testing (as Could feature). |
...
- We sized **TAM** with global Hajj/Umrah volumes and grounded average costs; **SAM** is BD/ID/MY with locally sourced prices and quotas; **SOM** is deliberately **bottom-up** from our December budget and five pilot partners per Antler’s guidance. ([zamzamtravelsbd.com](https://zamzamtravelsbd.com/?utm_source=chatgpt.com))
